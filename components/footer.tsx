    ...
    <footer className="relative z-20 pt-24 pb-12 overflow-hidden">
      ...
      <div className="container px-4 md:px-6 mx-auto mb-24">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="relative rounded-[3rem] overflow-hidden bg-emerald-500 p-12 md:p-20 text-center"
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <button className="px-10 py-5 bg-slate-950 hover:bg-slate-900 text-white font-semibold rounded-full transition-all flex items-center justify-center gap-2 mx-auto group text-lg shadow-2xl shadow-slate-950/20">
      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-2xl tracking-tight text-white">Hitrace</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Home', 'About Us', 'Blog', 'Book a Demo', 'Offices'].map((link) => (
                <li key={link}>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-slate-400 text-sm">
                ...
                <a href="mailto:hello@hitracesolutions.com" className="hover:text-emerald-400 transition-colors">hello@hitracesolutions.com</a>
              </li>
              <li className="flex items-center gap-3 text-slate-400 text-sm">
                <Mail className="w-5 h-5 text-emerald-400 shrink-0" />
                <a href="mailto:support@hitracesolutions.com" className="hover:text-emerald-400 transition-colors">support@hitracesolutions.com</a>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            {/* Social placeholders */}
            <div className="w-10 h-10 rounded-full glass border-white/10 flex items-center justify-center hover:bg-emerald-500/20 hover:text-emerald-400 transition-colors cursor-pointer text-slate-400">
