...
export function Stats() {
  ...
  return (
    <section className="relative z-20 -mt-12 mb-24 px-4 md:px-6">
      <div className="container mx-auto">
        <motion.div
          ...
          className="glass rounded-3xl p-8 md:p-12 border-white/10 shadow-2xl shadow-emerald-900/10"
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 divide-y md:divide-y-0 md:divide-x divide-white/10">
            {stats.map((stat, index) => (
              <div key={index} className="flex flex-col items-center justify-center pt-8 md:pt-0 first:pt-0 text-center">
                ...
                <div className="text-emerald-400 font-medium tracking-wide uppercase text-sm">
                  {stat.label}
                </div>
              </div>
            ))}
